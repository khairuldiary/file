...
document.write('<div id="toc-outer"><div id="results"></div><div id="itempager" style="position:relative;"><div id="pagination"></div><div id="totalposts"></div><a title="Khairul Diary" style="display:block!important;visibility:visible!important;opacity:1!important;position:absolute;bottom:10px;right:16px;font:normal bold 8px Arial,Sans-Serif!important;color:#888;text-shadow:0 1pxblack;text-decoration:none;" href="http://khairuldiary.blogspot.com" target="_blank">&#9658;KD</a></div></div>');
